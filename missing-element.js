...
{   
    ...
    firstPart = [ "Przymiotniki narodowości.", "Marie Curie était une scientifique", "Emmanuel Macron est un président", "Angela Merkel est une femme politique", "Pablo Picasso était un peintre", "Sophia Loren est une actrice", "Alexeï Navalny était un opposant héroïque", "Elizabeth II était une reine", "Barack Obama est un ancien président", "Coco Chanel était une créatrice de mode", "Cristiano Ronaldo est un footballeur", "Frida Kahlo était une artiste", "Xi Jinping est un dirigeant", "Greta Thunberg est une militante", "Justin Trudeau est un Premier ministre", "Shakira est une chanteuse" ];
    secondPart = [ "Complétez les phrases l'adjectif de nationalité.", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "." ];
    missingElement = [ "Adjectifs de nationalité", "polonaise", "français", "allemande", "espagnol", "italienne", "russe", "britannique", "américain", "française", "portugais", "mexicaine", "chinois", "suédoise", "canadien", "colombienne" ];
    hints = [ "nan", "La capitale de ce pays est Varsovie", "La capitale de ce pays est Paris", "La capitale de ce pays est Berlin", "La capitale de ce pays est Madrid", "La capitale de ce pays est Rome", "La capitale de ce pays est Moscou", "La capitale de ce pays est Londres", "La capitale de ce pays est Washington", "Ce pays est connu pour la Tour Eiffel", "La capitale de ce pays est Lisbonne", "La capitale de ce pays est Mexico", "La capitale de ce pays est Pékin", "La capitale de ce pays est Stockholm", "La capitale de ce pays est Ottawa", "La capitale de ce pays est Bogota" ];
