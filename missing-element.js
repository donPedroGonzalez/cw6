...
{   
    ...
    secondPart = [ "Complétez les phrases avec la forme correcte de l'adjectif de nationalité.", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "." ];
    missingElement = [ "Les adjectifs de nationalité", "polonaise", "français", "allemande", "espagnol", "italienne", "russe", "britannique", "américain", "française", "portugais", "mexicaine", "chinois", "suédoise", "canadien", "colombienne" ];
